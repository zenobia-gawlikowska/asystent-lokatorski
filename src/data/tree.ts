...
export const tree: DecisionTree = [
  {
    ...
    caseTypes: [
      ...
      },
      {
        ...
        label: {
          pl: "Zły stan lokalu komunalnego (zaniedbanie napraw)",
          ua: "Поганий стан комунального житла (занедбання ремонту)",
          ru: "Плохое состояние муниципального жилья (халатность в ремонте)",
          en: "Poor condition of municipal flat (neglected repairs)",
          es: "Mal estado del piso municipal (reparaciones descuidadas)",
          fr: "Mauvais état du logement municipal (réparations négligées)",
        },
        description: {
          pl: "Mieszkam w lokalu komunalnym — mieszkanie wymaga naprawy lub remontu, a Miasto nie reaguje na zgłoszenia.",
          ua: "Я мешкаю в комунальному житлі — квартира потребує ремонту, а Місто не реагує на звернення.",
          ru: "Я проживаю в муниципальном жилье — жильё требует ремонта, а Город не реагирует на обращения.",
          en: "I live in a municipal flat — the property needs repairs and the City is not responding to my requests.",
          es: "Vivo en un piso municipal — el inmueble necesita reparaciones y el Ayuntamiento no responde a mis solicitudes.",
          fr: "Je vis dans un logement municipal — le bien nécessite des réparations et la Ville ne répond pas à mes demandes.",
        },
        stages: [
          {
            id: "obnizka-czynszu",
            label: {
              pl: "Chcę obniżyć czynsz z powodu złego stanu lokalu komunalnego",
              ua: "Хочу знизити орендну плату через поганий стан комунального житла",
              ru: "Хочу снизить арендную плату из-за плохого состояния муниципального жилья",
              en: "I want to reduce rent due to poor condition of the municipal flat",
              es: "Quiero reducir el alquiler por el mal estado del piso municipal",
              fr: "Je veux réduire le loyer en raison du mauvais état du logement municipal",
            },
            documents: [
              {
